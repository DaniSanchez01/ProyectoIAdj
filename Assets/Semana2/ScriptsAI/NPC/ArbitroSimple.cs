...
public class ArbitroSimple : IArbitraje
{
    ...
    public Steering calcula(List<SteeringBehaviour> steerings,Agent agente)
    {
        ...
        //Nota2: el algoritmo comentado de la diapositiva 7 del tema 8 tiene una errata porque pone "max" y debería ser "min" cuando comprueba que los steer.linear y steer.angular obtenidos
